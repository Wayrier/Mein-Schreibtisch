...
// =======================================
// edit_appointment_ajax.php
// Zweck: Termin via AJAX bearbeiten
// =======================================
...
try {
    ...
    if (!$appointment) {
        send_json([
            'success' => false,
            'message' => 'Termin nicht gefunden oder Zugriff verweigert.'
        ]);
    }
    ...
    send_json([
        'success' => false,
        'message' => 'Termin konnte nicht aktualisiert werden. Bitte versuchen Sie es spaeter erneut.'
    ]);
}
